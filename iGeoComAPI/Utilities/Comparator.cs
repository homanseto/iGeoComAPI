...
namespace iGeoComAPI.Utilities
{
    ...
    {
        public static void FindDiffernet(List<IGeoComModel> Left, List<IGeoComGrabModel> Right, string status, List<String> properties)
        {
        ...
        */
        public static List<IGeoComModel> LeftIntersection(List<IGeoComModel> newData, List<IGeoComModel> added)
        {
            int newDataLength = newData.Count;
            int addedLength = added.Count;
            List<IGeoComModel> LeftIntersectionIGeoComList = new List<IGeoComModel>();
        ...
        public static List<IGeoComModel> RightIntersection(List<IGeoComModel> previousData, List<IGeoComDeltaModel> removed)
        {
        ...
        public static List<IGeoComModel> newModified(List<IGeoComModel> left, List<IGeoComModel> right)
        {
            int leftLength = left.Count;
            int rightLength = right.Count;
            List<IGeoComModel> ModifiedIGeoComList = new List<IGeoComModel>();
        ...
        public static List<IGeoComModel> orgModified(List<IGeoComModel> previousData, List<IGeoComModel> right)
        {
        ...
        public static List<IGeoComModel> MergeResults(List<IGeoComModel> added, List<IGeoComModel> removed, List<IGeoComModel> newDelta, List<IGeoComModel> orgDelta)
        {
            List<IGeoComModel> DeltaChange = new List<IGeoComModel>();
            List<IGeoComModel> mergeAddedAndRemoved = added.Concat(removed).ToList();
