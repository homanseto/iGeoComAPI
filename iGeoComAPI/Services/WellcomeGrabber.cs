...
namespace iGeoComAPI.Services
{
    public class WellcomeGrabber: AbstractGrabber
    {
        ...
        //public List<IGeoComDeltaModel> FindAdded(List<IGeoComGrabModel> newData, List<IGeoComRepository> previousData)
        //{
        ...
        //public List<IGeoComDeltaModel> FindRemoved(List<IGeoComRepository> previousData, List<IGeoComGrabModel> newData)
        //{
        //    int newDataLength = newData.Count;
        //    int previousDataLength = previousData.Count;
        ...
        //public List<IGeoComRepository> RightIntersection(List<IGeoComRepository> previousData, List<IGeoComDeltaModel> removed)
        //{
        ...
        //public List<IGeoComDeltaModel> newModified(List<IGeoComGrabModel> left, List<IGeoComRepository> right)
        //{
        ...
        //public List<IGeoComDeltaModel> orgModified(List<IGeoComRepository> previousData, List<IGeoComGrabModel> right)
        //{
