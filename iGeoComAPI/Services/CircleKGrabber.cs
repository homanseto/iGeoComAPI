...
namespace iGeoComAPI.Services
{
    public class CircleKGrabber 
    {
        ...
        {
            var rawDataEng = await _puppeteerConnection.PuppeteerSignalGrabber<string>(_options.Value.EnUrl, infoCode, waitSelector);
            var rawDataZh = await _puppeteerConnection.PuppeteerSignalGrabber<string>(_options.Value.ZhUrl, infoCode, waitSelector);
