...
namespace iGeoComAPI.Repository
{
    public class IGeoComRepository
    {
        ...
        public async Task<List<IGeoComGrabModel>> GetShops(string id)
        {
            ...
            */
            //name = $"%{name}%";
            string query = "SELECT GEONAMEID,ENGLISHNAME,CHINESENAME,ClASS,TYPE,SUBCAT,EASTING,NORTHING,SOURCE,E_FLOOR,C_FLOOR,E_SITENAME,C_SITENAME,E_AREA,C_AREA,E_DISTRICT,C_DISTRICT,E_REGION,C_REGION,E_ADDRESS,C_ADDRESS,TEL_NO,FAX_NO,WEB_SITE,REV_DATE FROM igeocom_june2022 WHERE Shopid = @id ";
